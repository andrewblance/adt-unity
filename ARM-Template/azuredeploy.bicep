...
resource appserver 'Microsoft.Web/serverfarms@2022-09-01' = {
  name: serverFarmName
  location: location
  kind: 'functionapp'
  sku: {
...
resource ingestfunction 'Microsoft.Web/sites/extensions@2022-03-01' = {
...
resource rgroledef 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
...
resource storageroledef 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
...
resource adtroledefapp 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
...
resource ADTRoleDefinitionUser 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
...
resource ADTRoleDefinitionAppReg 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
